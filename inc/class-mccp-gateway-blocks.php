...
if (!class_exists('WC_MCCP_Blocks_Support')) {
    final class WC_MCCP_Blocks_Support extends AbstractPaymentMethodType
    {
        ...
        {
            $this->settings = get_option('woocommerce_wc_mccp_settings', array());
